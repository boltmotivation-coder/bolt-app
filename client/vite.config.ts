  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          {
            src: 'assets/favicon-32x32-v5.png',
            sizes: '32x32',
            type: 'image/png',
          },
          {
            src: 'assets/favicon-16x16-v5.png',
            sizes: '16x16',
            type: 'image/png',
          },
          {
            src: 'assets/apple-touch-icon-180x180-v5.png',
            sizes: '180x180',
            type: 'image/png',
          },
          {
            src: 'assets/icon-192x192-v5.png',
            sizes: '192x192',
            type: 'image/png',
          },
          {
            src: 'assets/icon-512x512-v5.png',
            sizes: '512x512',
            type: 'image/png',
          },
          {
            src: 'assets/maskable-icon-v5.png',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'maskable',
          },
